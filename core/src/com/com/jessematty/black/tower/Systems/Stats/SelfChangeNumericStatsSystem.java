...
public class SelfChangeNumericStatsSystem extends GameTimeIntervalSystem {
    ...
    public void addedToEngine(Engine engine) {
        numericStatsComponentMapper= GameComponentMapper.getNumericStatsComponentMapper();
            numericStatsChangableComponentMapper =GameComponentMapper.getNumericStatsSelfChangableComponentMapper();
    ...
    protected void updateInterval() {
        entities= getEngine().getEntitiesFor(Family.all( SelfChangableNumericStatChangeable.class, NumericStats.class).get());
        ...
        for(int count=0; count<size; count++) {
            ...
            Array<SelfChangableNumericStatChangeable> changeableNumericStats= numericStatsSelfChangable.getStatsToChange();
            int size2=changeableNumericStats.size;
            for(int count2=0; count2<size2; count2++ ){
                // get self changing  numeric stat
                SelfChangableNumericStatChangeable changeableNumericStat=changeableNumericStats.get(count2);
    ...
    private boolean canChangeStat(SelfChangableNumericStatChangeable stat, NumericStats numericStats){
