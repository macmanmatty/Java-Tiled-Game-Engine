...
import com.jessematty.black.tower.Components.Other.CurseItem;
...
public class CurseItemSystem extends GameEntitySystem {
    ...
    public void update(float deltaTime) {
        ImmutableArray<Entity> entities = getEngine().getEntitiesFor(Family.all(Attachable.class, ItemComponent.class, CurseItem.class).get());
