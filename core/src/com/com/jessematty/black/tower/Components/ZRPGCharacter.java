...
public class ZRPGCharacter implements Component {
    ...
    private com.jessematty.black.tower.Components.Containers.Pack pack;
    ...
    public ZRPGCharacter(World world, Entity playerEntity) {
        ...
        this.pack= playerEntity.getComponent(com.jessematty.black.tower.Components.Containers.Pack.class);
