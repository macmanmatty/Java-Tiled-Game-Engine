...
public class NumericStatsChangeComponent implements Component {
    private String changeAction;
    private boolean addStat;
    private Entity changerEntity;

    public NumericStatsChangeComponent(Entity changerEntity, String changeAction, boolean addStat) {
