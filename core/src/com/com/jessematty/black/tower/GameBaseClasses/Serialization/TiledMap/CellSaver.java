 ...
 * mimics a libGDX @linked TiledMapTile Cell
 */
public class CellSaver {
    ...
    /**
     ...
     // the names of the texture regions if the cell isn't animated  there is only one region
     */
    String [] regionNames;
    /**
     * is the Cell animated
     */
    boolean animated;
    /**
     * is the cell colored?
    ...
    boolean colored;
    /**
     * the animation frame change interval  if the cell is animated
     */
    float interval;
    /**
     * the float value for the brightness
     */
    float brightness;
    /**
     * the color  of the tile if it is colored
     */
    NamedColor color;
    /**
     * // the class that implements TiledMapTile to deserialize into
     */
