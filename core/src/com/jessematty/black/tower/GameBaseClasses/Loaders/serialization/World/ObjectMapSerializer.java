...
public class ObjectMapSerializer<K,  V> implements Serializer<ObjectMap<K, V>> { // serializer for the libgdx atlas region class
    ...
    public void write(Json json, ObjectMap<K, V> map, Class aClass) {
        String tag = com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity.TagResolver.getTag(json, aClass);
    ...
    public ObjectMap read(Json json, JsonValue jsonValue, Class aClass) {
        ...
        String tag = com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity.TagResolver.getTag(json, ObjectMap.class);
    ...
    private K readKey(Json json, JsonValue jsonValue) throws ReflectionException, IllegalAccessException, InstantiationException {
        ...
        Class<K> keyType = com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity.TagResolver.getClass(json,  classNme);
    ...
    private V readValue(Json json, JsonValue jsonValue) throws ReflectionException, IllegalAccessException, InstantiationException {
        ...
        Class<V> valueType = com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity.TagResolver.getClass(json,  classNme);
    ...
    private void writeKey( Json json,  K key){
        ...
        String tag = com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity.TagResolver.getTag(json, type);
        json.writeObjectStart(tag);
