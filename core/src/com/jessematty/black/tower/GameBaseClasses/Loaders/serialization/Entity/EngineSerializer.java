package com.jessematty.black.tower.GameBaseClasses.Loaders.serialization.Entity;
...
public class EngineSerializer<T extends Engine> implements Json.Serializer<T> {
     ...
     * @param entityFilter
     */
    public EngineSerializer(EntityFilter entityFilter,Engine engine ) {
    ...
    private void prepareEntitySerializer(Json json) {
        ...
        if (serializer instanceof EntitySerializer) {
            ...
            entitySerializer = new EntitySerializer(null);
