...
public class ItemListTitle<T> extends Label {
    ...
    public ItemListTitle(final ItemList<T> itemList, final String name, Skin skin) {
    ...
    public ItemListTitle(final ItemList<T> itemList, final String name, ItemListTitleStyle itemListStyle) {
   ...
   private ItemListTitle<T> getLabel(){
        return this;
    }
    @Override
