...
public class NumericStatChangeableGroup extends NumericStatGroup {
    ...
    public NumericStatChangeableGroup(Skin skin, NumericStatChangeable numericStat, boolean editable) {
