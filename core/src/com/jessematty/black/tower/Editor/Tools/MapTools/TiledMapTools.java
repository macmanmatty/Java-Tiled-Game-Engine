...
public class TiledMapTools {
    ...
    /**
     * converts tiled tiled map to a rpg-creator tiled map
     *
     * @param oldTiledMap               the libgdx  tiled tamp to generate an atlas from
     ...
     */
    public TiledMap addTiledMapRegionsToAtlas(TiledMap oldTiledMap, String mapName) throws MapLoadingExeception {
            ...
            for (int countx = 0; countx < width; countx++) {
                for (int county = 0; county < height; county++) {
                    ...
                    if (oldTile instanceof StaticTiledMapTile) {
                        newTile = addStaticTileTextureToAtlas(oldCell, mapName);
                    } else if (oldTile instanceof AnimatedTiledMapTile) {

                        newTile = addAnimatedTileTextureToAtlas(oldCell, mapName);
                    }
