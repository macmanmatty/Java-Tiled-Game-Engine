...
public class ShopEditScreen extends MapEditScreen {
    public ShopEditScreen(GameAssets assets, TopMenu topMenu, DragAndDrop dragAndDrop, KeyListener keyListener, Skin skin, World world, WorldObjects worldObjects) {
