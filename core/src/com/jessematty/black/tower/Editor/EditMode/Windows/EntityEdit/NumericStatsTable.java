...
public class NumericStatsTable {
    ...
    public NumericStatsTable(Entity entity, Skin skin) {
        ...
        this.numericStatsChangable=entity.getComponent(NumericStatsChangable.class);
        this.booleanStatsChangable=entity.getComponent(BooleanStatsChangable.class);
        this.stringStatsChangable=entity.getComponent(StringStatsChangable.class);
        this.entity=entity;
        this.skin=skin;
        table.setDebug(true);
    }
