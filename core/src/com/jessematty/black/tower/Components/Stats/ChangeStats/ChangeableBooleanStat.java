...
public class ChangableBooleanStat extends com.jessematty.black.tower.Components.Stats.BooleanStat {
   ...
   private Array<String> actionsToChangeOn = new Array<String>();
    ...
    public ChangableBooleanStat(boolean displayable, String name, boolean flag, int amountOfTimeToChangeFor) {
        super(displayable, name, flag);
        this.flag = flag;
        this.amountOfTimeToChangeFor = amountOfTimeToChangeFor;
    }

    public ChangableBooleanStat(boolean displayable, String name, boolean flag, com.jessematty.black.tower.Components.Stats.BooleanStatCombine booleanStatCombine, int amountOfTimeToChangeFor) {
        super(displayable, name, flag);
        this.flag = flag;
        this.amountOfTimeToChangeFor = amountOfTimeToChangeFor;
    ...
    public ChangableBooleanStat(boolean displayable, String name, boolean flag, int amountOfTimeToChangeFor, com.jessematty.black.tower.Components.Stats.BooleanStatCombine combineMode, List<String> actionsToChangeOn) {
        super(displayable, name, flag);
        this.amountOfTimeToChangeFor = amountOfTimeToChangeFor;
        this.combineMode = combineMode;
    }

    public ChangableBooleanStat() {
    }




    public ChangableBooleanStat(ChangableBooleanStat other) {
        super(other);
        this.amountOfTimeToChangeFor = other.amountOfTimeToChangeFor;
        this.combineMode = other.combineMode;
    }

    public ChangableBooleanStat(BooleanStat other) {
        super(other);
    }
