...
public class AddItemToPack extends GameEntitySystem {
    ...
    public AddItemToPack(MapDraw draw) {
        super(draw);
    }
    ...
    public void update(float deltaTime) {
        ...
        ImmutableArray<Entity> entities=getEngine().getEntitiesFor(Family.all( Container.class, AddItemToContainerComponent.class, Position.class).get());
