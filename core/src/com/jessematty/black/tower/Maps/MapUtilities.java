...
public class MapUtilities {
    ...
    public static void addEntityToTile( GameMap map, LandSquareTile tile, Entity entity, Position position){
    ...
    public static GameMap getEntityMap(World world, Position position){
            ...
            for (int county = -yTiles; county < yTiles; county++) {
                ...
                if (tile != null) {
                    ...
                    for (int count = 0; count < size; count++) {
                        ...
                        if (!InList.isInList(entity, entities)) {
                            entities.add(entity);
                        }
    ...
    public static Array<Entity> getClosestEntities( Map map, Position position, float distance, Class<? extends Component>... components) {
    ...
    public static List<LandSquareTile> getSurroundingTiles( Map map , Position position) {  //returns the surronding tiles for a given object based on the texture width and height.
    ...
    public static Array<LandSquareTile> getSurroundingTiles( Map map,  Position position, float distance) {  //returns the surronding tiles for a given object based on the texture width and height.
    ...
    public static LandSquareTile getNextTile( World world, Position position){
    ...
    public static Vector2 getDistance(Position thing1, Position thing2) {
